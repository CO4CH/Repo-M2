...
document.querySelector('#createdBy').innerHTML = 'Aplicación creada por Andres'
...
function buildToDos(toDos) {
  // Tu código acá:
  let array = toDos.map((function(e, id){return buildToDo(e, id)}));
  return array;
}
...
function displayToDos() {
  ...
  array.forEach(element => { return toDoContainer.appendChild(element) });
